...
import { CustomReportTableData } from "@/utils/types";
...
export function ExpenseCustomReportTable({
  onOpenRow = () => {},
  data,
  isInDrawer = false,
}: ExpenseTableProps) {
  const [tableColumnWidths, setTableColumnWidths] = useState([
    ...
    { columnId: "subCompanyName", value: 72, unit: "px" },
    { columnId: "name", value: 180, unit: "px" },
    { columnId: "customReportType", value: 90, unit: "px" },
    { columnId: "status", value: 25, unit: "%" },
    { columnId: "userEmail", value: 20, unit: "%" },
    { columnId: "sendDate", value: 25, unit: "%" },
  ...
  const combinedColumns = customFormColumns.map((column) => {
  ...
  const orderedData: Array<CustomReportTableData> =
    processAndOrderDataByFieldTitlePairs(data, customFormColumns);
